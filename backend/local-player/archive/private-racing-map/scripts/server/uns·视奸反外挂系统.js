...
// world.onTick(({elapsedTimeMS,tick})=>{
//     if(tick%16==0){
//     /*    console.log('卡顿:'+world.kd); */
//         world.kd=0;
//     }
//     world.kd=Math.max(elapsedTimeMS,world.kd);
// });

// setInterval(() => { 
//     world.querySelectorAll('player').forEach((entity)=>{
//         if(world.ucnt%200==0)entity.player.directMessage('uns·视奸反外挂系统已启动，请勿试图开挂，一经发现，直接永封！');
//         let sp=d(entity.lastPosition,entity.position);
//         let mx=entity.player.runSpeed*35+2.4; mx*=0.2;
//         if(sp>mx&&entity.special==0&&entity.enableDamage==1&&world.gameStarting&&world.kd<80){
//             entity.position.copy(entity.lastPosition);
//             entity.wgcnt++;
//             if(entity.wgcnt>5){
